...
public class ArliterestApi {
   ...
   * @return ARTokenDto
   */
  public ARTokenDto  getPartnerToken (String username, String password, String aRLiteToken) throws ApiException {
    Object localVarPostBody = null;
    // verify the required parameter 'username' is set
    if (username == null) {
       throw new ApiException(400, "Missing the required parameter 'username' when calling getPartnerToken");
    }
    // verify the required parameter 'password' is set
    if (password == null) {
       throw new ApiException(400, "Missing the required parameter 'password' when calling getPartnerToken");
    }
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI(basePath, localVarPath, "GET", localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarFormParams, localVarContentType);
      if(localVarResponse != null){
        return (ARTokenDto) ApiInvoker.deserialize(localVarResponse, "", ARTokenDto.class);
      }
      else {
        return null;
      }
   ...
   * @return HelloDto
   */
  public HelloDto  hello (String name, String aRLiteToken) throws ApiException {
    Object localVarPostBody = null;
    // verify the required parameter 'name' is set
    if (name == null) {
       throw new ApiException(400, "Missing the required parameter 'name' when calling hello");
    }
   ...
   */
  public PlainResultDto  logout (String aRLiteToken) throws ApiException {
    Object localVarPostBody = null;
   ...
   */
  public StandardResponse  sendMessage (AMessage messageDto, String aRLiteToken) throws ApiException {
    Object localVarPostBody = messageDto;
    // verify the required parameter 'messageDto' is set
    if (messageDto == null) {
       throw new ApiException(400, "Missing the required parameter 'messageDto' when calling sendMessage");
    }
   ...
   * @return Integer
   */
  public Integer  throwError (String aRLiteToken) throws ApiException {
    Object localVarPostBody = null;
